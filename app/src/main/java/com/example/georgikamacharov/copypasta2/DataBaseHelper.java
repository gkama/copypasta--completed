...
/**
 * Created by gkam4141 on 5/5/2015.
 */
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static final String pkg = "com.example.georgikamacharov.copypasta2";
    private static String DB_PATH = "/data/data/" + pkg + "/databases/";

    private static String DB_NAME = "copypastas.sqlite";
    int[] dbfiles = { R.drawable.copypastas};
    ...
    public Cursor fetchData() {
        Cursor cursor = getReadableDatabase().rawQuery("SELECT * FROM " + "copypastasTable", null);
        return cursor;
        }
